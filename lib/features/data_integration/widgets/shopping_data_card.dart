...
class ShoppingDataCard extends StatelessWidget {
  const ShoppingDataCard({
    super.key,
  ...
  final List<ShoppingDetailItem> previewItems;
  final String source;
  final String starId;
